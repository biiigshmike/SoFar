...
private extension BudgetDetailsView {
    ...
    var listHeader: some View {
        VStack(alignment: .leading, spacing: headerSpacing) {
            ...
            GlassCapsuleContainer(horizontalPadding: DS.Spacing.s, verticalPadding: DS.Spacing.s) {
...
// ... (Rest of BudgetDetailsView.swift remains the same)
...
private struct FilterBar: View {
    ...
    var body: some View {
        // This is now handled by the custom picker, no need for the container here.
        PlatformAwareSegmentedPicker(selection: $sort) {
            Text("A–Z").tag(BudgetDetailsViewModel.SortOption.titleAZ)
            Text("$↓").tag(BudgetDetailsViewModel.SortOption.amountLowHigh)
            Text("$↑").tag(BudgetDetailsViewModel.SortOption.amountHighLow)
            Text("Date ↑").tag(BudgetDetailsViewModel.SortOption.dateOldNew)
